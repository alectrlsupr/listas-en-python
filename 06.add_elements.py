...
# Para agregar elementos podemos utilizar la función insert() que viene en todas las listas. El primer parámetro es el índice que ocupará el nuevo elemento
